  ...
  const products = [
    {
      ...
      images: JSON.stringify(['https://images.pexels.com/photos/1092644/pexels-photo-1092644.jpeg', 'https://images.pexels.com/photos/788946/pexels-photo-788946.jpeg']),
      categoryId: catMap['mobile-covers'], brand: 'TS Shield', stockQuantity: 50, isFeatured: true,
      tags: JSON.stringify(['iphone', 'case', 'protection']), warrantyInfo: '6 months warranty',
    },
    {
      ...
      images: JSON.stringify(['https://images.pexels.com/photos/4526414/pexels-photo-4526414.jpeg']),
      categoryId: catMap['chargers'], brand: 'TS Power', stockQuantity: 30, isFeatured: true, fastDelivery: true,
      tags: JSON.stringify(['charger', 'gan', 'fast-charge']), warrantyInfo: '1 year warranty',
    },
    {
      ...
      images: JSON.stringify(['https://images.pexels.com/photos/3825581/pexels-photo-3825581.jpeg']),
      categoryId: catMap['cables'], brand: 'TS Link', stockQuantity: 100, fastDelivery: true,
      tags: JSON.stringify(['cable', 'usb-c', 'charging']), warrantyInfo: '6 months warranty',
    },
    {
      ...
      images: JSON.stringify(['https://images.pexels.com/photos/3394650/pexels-photo-3394650.jpeg']),
      categoryId: catMap['earphones'], brand: 'TS Audio', stockQuantity: 45, isFeatured: true,
      tags: JSON.stringify(['earphones', 'bass', 'audio']), warrantyInfo: '6 months warranty',
    },
    {
      ...
      images: JSON.stringify(['https://images.pexels.com/photos/7974/pexels-photo.jpg']),
      categoryId: catMap['laptop-accessories'], brand: 'TS Gear', stockQuantity: 25,
      tags: JSON.stringify(['laptop', 'sleeve', 'bag']), warrantyInfo: '3 months warranty',
    },
    {
      ...
      tags: JSON.stringify(['smartwatch', 'fitness', 'waterproof']), warrantyInfo: '1 year warranty',
    },
    {
      ...
      images: JSON.stringify(['https://images.pexels.com/photos/4526407/pexels-photo-4526407.jpeg']),
      categoryId: catMap['power-banks'], brand: 'TS Power', stockQuantity: 40, isFeatured: true, isDailyDeal: true,
      tags: JSON.stringify(['powerbank', 'portable', 'charging']), warrantyInfo: '1 year warranty',
    },
    {
      ...
      images: JSON.stringify(['https://images.pexels.com/photos/356056/pexels-photo-356056.jpeg']),
      categoryId: catMap['other-gadgets'], brand: 'TS Drive', stockQuantity: 60,
      tags: JSON.stringify(['car', 'mount', 'holder']), warrantyInfo: '3 months warranty',
    },
    {
      ...
      images: JSON.stringify(['https://images.pexels.com/photos/1092644/pexels-photo-1092644.jpeg']),
      categoryId: catMap['mobile-covers'], brand: 'TS Shield', stockQuantity: 70, isDailyDeal: true,
      tags: JSON.stringify(['samsung', 'case', 'clear']), warrantyInfo: '6 months warranty',
    },
    {
      ...
      tags: JSON.stringify(['airpods', 'case', 'leather']), warrantyInfo: '3 months warranty',
    },
  ];
